...
str_imgfile = 'C:\Users\Omer\Desktop\2AFC Temporary\slow_20ms_15msexp0004.png';
str_csvfile = 'C:\Users\Omer\Desktop\2AFC Temporary\slow_20ms_15msexp0004.csv';
...
for i = 1:num_rows;
    ...
    for j = 1:grid_cols
        ...
        patch = img_data(round(csv_data_peak(counter,2))-4:round(csv_data_peak(counter,2))+4, round(csv_data_peak(counter,1))-4:round(csv_data_peak(counter,1))+4);
